...
public class MicrometerHttpClient extends HttpClient {
    ...
    @Nullable
    private final io.micrometer.core.instrument.binder.jdk.HttpClientObservationConvention customObservationConvention;
    ...
    private MicrometerHttpClient(MeterRegistry meterRegistry, HttpClient client,
                                 ...
                                 @Nullable io.micrometer.core.instrument.binder.jdk.HttpClientObservationConvention customObservationConvention,
    ...
    public static class InstrumentationBuilder {
        ...
        @Nullable
        private io.micrometer.core.instrument.binder.jdk.HttpClientObservationConvention customObservationConvention;
         ...
         * {@link io.micrometer.core.instrument.binder.jdk.HttpClientObservationConvention}.
         * @param customObservationConvention custom observation convention
         * @return this
         */
        public InstrumentationBuilder customObservationConvention(
                io.micrometer.core.instrument.binder.jdk.HttpClientObservationConvention customObservationConvention) {
            this.customObservationConvention = customObservationConvention;
            return this;
        }
    ...
    public <T> HttpResponse<T> send(HttpRequest httpRequest, HttpResponse.BodyHandler<T> bodyHandler)
        ...
        ObservationOrTimerCompatibleInstrumentation<io.micrometer.core.instrument.binder.jdk.HttpClientContext> instrumentation = observationOrTimer(
                httpRequestBuilder);
    ...
    private <T> void stopObservationOrTimer(
            ObservationOrTimerCompatibleInstrumentation<io.micrometer.core.instrument.binder.jdk.HttpClientContext> instrumentation, HttpRequest request,
            @Nullable HttpResponse<T> res) {
        instrumentation.stop(io.micrometer.core.instrument.binder.jdk.DefaultHttpClientObservationConvention.INSTANCE.getName(), "Timer for JDK's HttpClient",
                () -> {
                    Tags tags = Tags.of(HttpClientObservationDocumentation.LowCardinalityKeys.METHOD.asString(),
                            ...
                            io.micrometer.core.instrument.binder.jdk.DefaultHttpClientObservationConvention.INSTANCE.getUriTag(request, res, uriMapper));
                    if (res != null) {
                        tags = tags
    ...
    private ObservationOrTimerCompatibleInstrumentation<io.micrometer.core.instrument.binder.jdk.HttpClientContext> observationOrTimer(
            HttpRequest.Builder httpRequestBuilder) {
        return ObservationOrTimerCompatibleInstrumentation.start(this.meterRegistry, this.observationRegistry, () -> {
            io.micrometer.core.instrument.binder.jdk.HttpClientContext context = new io.micrometer.core.instrument.binder.jdk.HttpClientContext(this.uriMapper);
            context.setCarrier(httpRequestBuilder);
            return context;
        }, this.customObservationConvention, io.micrometer.core.instrument.binder.jdk.DefaultHttpClientObservationConvention.INSTANCE);
    }
