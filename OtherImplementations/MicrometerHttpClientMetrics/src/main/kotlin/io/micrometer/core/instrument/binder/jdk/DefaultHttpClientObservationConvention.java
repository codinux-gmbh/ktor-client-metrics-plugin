...
/**
 * Default implementation of {@link io.micrometer.core.instrument.binder.jdk.HttpClientObservationConvention}.
 *
 * @author Marcin Grzejszczak
 * @since 1.10.0
 */
public class DefaultHttpClientObservationConvention implements io.micrometer.core.instrument.binder.jdk.HttpClientObservationConvention {
    ...
    @Override
    public KeyValues getLowCardinalityKeyValues(io.micrometer.core.instrument.binder.jdk.HttpClientContext context) {
    ...
    @Nullable
    @Override
    public String getContextualName(io.micrometer.core.instrument.binder.jdk.HttpClientContext context) {
        if (context.getCarrier() == null) {
            return null;
        }
